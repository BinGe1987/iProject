...
- (instancetype)initWithView:(UIView *)view {
    ...
    DropdownMenu *menu = [[DropdownMenu alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 32) andDropdownViewHeight:500];
    ...
    vp.heightValueType = VALUE;
    vp.height = 30;
    FrameLayoutParams *lp = [FrameLayoutParams new];
    lp.marginTop = STATUSBARHIEGHT + 44;
    lp.gravity = FrameLayoutGravityTop;
    menu.viewParams = vp;
