...
//            [UIViewController pushController:@"ProfileEditController" animated:YES data:club];
...
//        }
//    }];
    [self.view showLoadingViewGrivaty:LoadingViewGravityCenter|LoadingViewGravityLeft padding:UIEdgeInsetsMake(10, 20, 10, 20)];
}
