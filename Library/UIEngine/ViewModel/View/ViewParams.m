...
- (void)initPaddingParams:(id<UIModel>)model {
    ...
    if (padding) {
        self.paddingLeft = self.paddingLeft? self.paddingLeft : padding;
        self.paddingTop = self.paddingTop? self.paddingTop : padding;
        self.paddingRight = self.paddingRight? self.paddingRight : padding;
        self.paddingBottom = self.paddingBottom? self.paddingBottom : padding;
    }
